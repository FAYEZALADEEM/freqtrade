# ملخص باكتيست: LIB_STR005_EMA

**التاريخ:** 2026-06-19 04:43
**الأمر المستخدم:**
```
/home/fayez/freqtrade/.venv/bin/freqtrade backtesting --config user_data/config.json --config <(echo '{"freqai": {"enabled": false}}') --strategy LIB_STR005_EMA --timeframe 15m --timerange 20250101-20260101 --fee 0 --export signals --cache none -p EUR/USDT
```
...
**رمز الخروج:** 0
**ملف السجل الكامل:** reports/backtests/LIB_STR005_EMA_20260619_044321.log
