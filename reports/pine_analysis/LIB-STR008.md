# تحليل Pine Script: LIB-STR008

**الملف الأصلي:** LIB-STR008.pine
**الإصدار:** Pine v6
**نوع:** Strategy
**تاريخ التحليل:** 2026-06-19 04:55
...
- `rsiLen = input...(14, "RSI Length / طول RSI", minval=2)`
...
- `volLookback = input...(20, "Volume SMA Length", minval=5)`
- `volSpikeMult = input...(1.2, "Volume Spike Multiplier", minval=0.1, step=0.1)`
- `fibLookback = input...(50, "Fibonacci Lookback / نافذة فيبوناتشي", minval=10)`
...
- enter_tag: `pine_lib-str008`
- exit_tag: `exit_pine_lib-str008`
