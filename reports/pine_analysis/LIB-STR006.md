# تحليل Pine Script: LIB-STR006

**الملف الأصلي:** LIB-STR006.pine
**الإصدار:** Pine v6
**نوع:** Strategy
**تاريخ التحليل:** 2026-06-19 04:49
...
- `zoneLookback = input...(30, "Supply/Demand Lookback / نافذة العرض والطلب", minval=10)`
...
- enter_tag: `pine_lib-str006`
- exit_tag: `exit_pine_lib-str006`
