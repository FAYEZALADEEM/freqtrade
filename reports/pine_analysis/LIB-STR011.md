# تحليل Pine Script: LIB-STR011

**الملف الأصلي:** LIB-STR011.pine
**الإصدار:** Pine v6
**نوع:** Strategy
**تاريخ التحليل:** 2026-06-19 06:28
...
close, low, open, volume, high

## 8. enter_tag / exit_tag المقترحة

- enter_tag: `pine_lib-str011`
- exit_tag: `exit_pine_lib-str011`
